...
baseline = baseline_scenario(TRIPS, DAY, initial_fill_ratio=0.60, out_csv="baseline_state.csv")
midnight = midnight_scenario(TRIPS, DAY, bucket_minutes=15, total_bikes_ratio=0.60)
